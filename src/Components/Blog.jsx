        ...
        <div>
          <div className="emaill">
                ...
                <nav className={"navbar navbar-expand-lg"} >
                  <div className="container-fluid">
                    ...
                    <ul className={"nav justify-content-center "} id='mcone' >
                      ...
                      <li className="nav-item">
                        <Link id='lgff' to='/Section' className="nav-link " aria-disabled="true">Services</Link>
                      </li>
                      <li className="nav-item">
            ...
            <section className='mainbloge'>
              <h1>Blog</h1><br /><h3>Home - <span className='bloge'>Blog</span></h3>
            </section>
            ...
            <section className='mainblogee' id='nexthdblog'>
              <h1>Blog</h1><br /><h3>Home - <span className='blogee'>Blog</span></h3>
            </section>
